export default {
  ...
  'pages.zwtoken.transfer.privacyAddress.required': '请输入接收方的隐私地址',
  'pages.zwtoken.transfer.privacyAddress.invalid': '请输入有效的以太坊地址',
  ...
  'pages.zwtoken.transfer.tip.1': '• 隐私地址通过Poseidon哈希生成',
  'pages.zwtoken.transfer.tip.2': '• 转账到新地址时，首次会自动生成commitment',
  'pages.zwtoken.transfer.tip.3': '• 接收方的地址和金额都是私有的',
  'pages.zwtoken.transfer.submitting': '交易提交中...',
  'pages.zwtoken.transfer.success': '转账成功！',
  'pages.zwtoken.transfer.failed': '转账失败',
  
  // Claim
  'pages.zwtoken.claim.secret': 'Secret (私钥)',
  'pages.zwtoken.claim.secret.placeholder': '请输入您的secret',
  'pages.zwtoken.claim.secret.required': '请输入您的secret',
