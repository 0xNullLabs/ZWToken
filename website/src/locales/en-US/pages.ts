export default {
  ...
  'pages.zwtoken.claim.seedModal.title': 'Generate Secret from Seed',
  'pages.zwtoken.claim.seedModal.waiting': 'Requesting wallet signature...',
  'pages.zwtoken.claim.seedModal.close': 'Close',
  'pages.zwtoken.claim.seedModal.index': 'Index',
  'pages.zwtoken.claim.seedModal.secret': 'Secret By Seed',
  'pages.zwtoken.claim.seedModal.amount': 'Amount',
  'pages.zwtoken.claim.seedModal.action': 'Action',
  'pages.zwtoken.claim.seedModal.select': 'Select',
  'pages.zwtoken.claim.seedModal.checking': 'Checking...',
  'pages.zwtoken.claim.seedModal.failed': 'Query Failed',
